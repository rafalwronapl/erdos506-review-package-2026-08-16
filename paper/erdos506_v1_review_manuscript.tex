...
\input{sections/01_foundations_small_cases}
\input{sections/02_finite_n10_n12}
\input{sections/03_n13_infinity_certificates}
...
This work was developed with substantial AI assistance, including
...
Erd\H{o}s Problem~506 or that every informal argument in this manuscript is
correct.  The work is therefore being submitted for independent human
